...
import { responsive, PROVINCE, DISTRICT, MUNICIPALITY, WARD_NO, VoterSmartContract, GENDER_OPTIONS, VOTE_ELIBILITY_AGE } from '../../constants';
...
const VoterRegistration = () => {
  ...
  const onSubmit = async () => {
    try {
      ...
      await VoterSmartContract.methods.registerVoter(
        fullName,
        citizenshipNumber,
        age,
